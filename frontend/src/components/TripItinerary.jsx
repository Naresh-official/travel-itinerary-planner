  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <Link to="/trips" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-4">
          ...
          {dayViewDates.length > 0 && (
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
              <h2 className="text-xl font-semibold mb-4">Day-by-Day View</h2>
        ...
        {trip.destinations && trip.destinations.length > 0 ? (
          ...
          <div className="text-center py-16">
            <div className="bg-white p-8 rounded-lg shadow-md max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">Add your first destination to start planning!</p>
              <button
                onClick={() => setShowDestinationForm(true)}
        ...
        {showDestinationForm && (
          <DestinationForm onSubmit={handleAddDestination} onCancel={() => setShowDestinationForm(false)} />
        )}
      </div>
    </div>
  )
